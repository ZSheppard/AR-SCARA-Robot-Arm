...
// Labs 1-6 written by Zachary Sheppard
////////////////////////////////////////////////////////////////
#include "stdafx.h"
...
void lab6(int cam_id)
{
    ...
    {
        cout << "\n*****************************************************";
        cout << "\n(A) - Inverse Kinematics (Virtual Camera)";
        cout << "\n(B) - Inverse Kinematics (Real Camera)";
        cout << "\n(0) Exit";
        cout << "\n>> ";
        cin >> sel;
        ...
        switch (sel)
        {
        case 'A': lab6A(cam_id); break;
        //case '6B': lab6A(cam_id); break;  //Not switched to 6B
        //case '0': cv::destroyAllWindows();
        }
    }
}
